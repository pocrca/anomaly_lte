...
def time_encoder(x):
    return np.reshape(np.array(x.iloc[:,0].dt.hour),(-1,1))
...
x_train_processed_ft1.to_csv('x_train_processed_ft1.csv')
x_test_processed_ft1.to_csv('x_test_processed_ft1.csv')
x_train_processed_ft2.to_csv('x_train_processed_ft2.csv')
x_test_processed_ft2.to_csv('x_test_processed_ft2.csv')